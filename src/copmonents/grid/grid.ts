...
export class Grid {
  ...
  products: { id: number; name: string; description: string; price: number; imageUrl: string; rating: number; category: string; }[];
...
constructor(){
  this.categories=["All","Shirts","Shorts","Kids","Shoes","Accesories"];
    this.products = [
    {
      ...
      price: 89.99,
      imageUrl: 'manutd/home_jersey.jpg',
      rating: 4.8,
      category: 'Jersey',
    },
    {
      ...
      price: 89.99,
      imageUrl: 'manutd/away_jersey.jpg',
      rating: 4.6,
      category: 'Jersey',
    },
    {
      ...
      price: 99.99,
      imageUrl: 'manutd/third_jersey.jpg',
      rating: 4.9,
      category: 'Jersey',
    },
    {
      ...
      price: 69.99,
      imageUrl: 'manutd/training_top.jpg',
      rating: 4.5,
      category: 'Training',
    },
    {
      ...
      price: 59.99,
      imageUrl: 'manutd/training_pants.jpg',
      rating: 4.3,
      category: 'Training',
    },
    {
      ...
      price: 49.99,
      imageUrl: 'manutd/home_shorts.jpg',
      rating: 4.4,
      category: 'Shorts',
    },
    {
      ...
      price: 49.99,
      imageUrl: 'manutd/away_shorts.jpg',
      rating: 4.2,
      category: 'Shorts',
    },
    {
    ...
    },
    {
      ...
      price: 99.99,
      imageUrl: 'manutd/anthem_jacket.jpg',
      rating: 4.9,
      category: 'Tracksuit',
    },
    {
...
getProductsByCategory(){
  ...
  // products = [
  //   { title: 'Premium Headphones', department: 'Electronics', description: 'Noise cancelling', image: './product1.jpg', price: 299, rating: 4.5, isNew: true },
  //   { title: 'Leather Bag', department: 'Bags', description: 'Luxury leather bag', image: './product2.jpg', price: 150, rating: 4.0, isNew: false },
  // ];
  //  selectedDepartment = 'All';

  // get departments() {
  //   return ['All', ...new Set(this.products.map(p => p.department))];
  // }

  // get filteredProducts() {
  //   return this.selectedDepartment === 'All'
  //     ? this.products
  //     : this.products.filter(p => p.department === this.selectedDepartment);
  // }
